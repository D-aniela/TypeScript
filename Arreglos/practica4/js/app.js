...
function EventListener() {
  // Keypress, reacciona cada que apretamos alguna tecla
  document
...
// Parametro, es un elemento de una aplicacion que manda una funcion y otra funcion recibe
// event viene de addEventListener
